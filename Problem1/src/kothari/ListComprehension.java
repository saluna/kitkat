...
public class ListComprehension {
	public static void main(String[] args) {
        ...
        List<Object> e0 = Arrays.asList(1, "MARTIN", "CARMEN", "MARTINCU", "3-MAR-90", "", "PRESIDENT", 4500, 0, 50, 0);
        ...
        List<Object> e3 = Arrays.asList(12, "GILSON", "SAM", "GILSONSJ", "18-JAN-92", "", "SALES REPRESENTATIVE", 1490, 12.5, 32, 3);
        List<Object> e4 = Arrays.asList(13, "SANDERS", "JASON", "SANDERJK", "18-FEB-91", "", "SALES REPRESENTATIVE", 1515, 10, 33, 3);
        List<Object> e5 = Arrays.asList(14, "DAMERON", "ANDRE", "DAMEROAP", "9-OCT-91", "", "SALES REPRESENTATIVE", 1450, 17.5, 35, 3);
        List<Object> e6 = Arrays.asList(15, "HARDWICK", "ELAINE", "HARDWIEM", "7-FEB-92", "", "STOCK CLERK", 1400, 0, 41, 6);
        List<Object> e7 = Arrays.asList(16, "BROWN", "GEORGE", "BROWNGW", "8-MAR-90", "", "STOCK CLERK", 940, 0, 41, 6);
        ...
        List<Object> e15 = Arrays.asList(23, "PEARL", "ROGER", "PEARLRG", "17-OCT-90", "", "STOCK CLERK", 795, 0, 34, 9);
        List<Object> e16 = Arrays.asList(24, "DANCER", "BONNIE", "DANCERBW", "17-MAR-91", "", "STOCK CLERK", 860, 0, 45, 7);
        ...
        List<Object> d0 = Arrays.asList(10, "FINANCE", 1);
        List<Object> d1 = Arrays.asList(31, "SALES", 1);
        List<Object> d2 = Arrays.asList(32, "SALES", 2);
        List<Object> d3 = Arrays.asList(33, "SALES", 3);
        List<Object> d4 = Arrays.asList(34, "SALES", 4);
        List<Object> d5 = Arrays.asList(35, "SALES", 5);
        List<Object> d6 = Arrays.asList(41, "OPERATIONS", 1);
        List<Object> d7 = Arrays.asList(42, "OPERATIONS", 2);
        List<Object> d8 = Arrays.asList(43, "OPERATIONS", 3);
        List<Object> d9 = Arrays.asList(44, "OPERATIONS", 4);
        List<Object> d10 = Arrays.asList(45, "OPERATIONS", 5);
        List<Object> d11 = Arrays.asList(50, "ADMINISTRATION", 1);
        ...
        // Select first name, last name, title, and salary of employees
        ...
        System.out.println("select last_name, first_name, title, salary from s_emp where salary < 1500: ");
        emp.stream()
